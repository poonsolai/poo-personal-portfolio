...
import img4 from '../assets/spms.png'
import img19 from '../assets/login.png'
import korea from '../assets/korea.png'
import projec from './projects.json'
...
function Cartimage(){
  ...
  const [project, setproject] = useState(projec);
  ...
  function setBackndProject(){
    setproject(projec.filter((p)=>(p.app === "fullstack")));
  }
  function setFrontProject(){
    setproject(projec.filter((p)=>(p.app === "frontend")));
  }
    ...
    <div className="container-fulid m-5" id='container'>
      ...
      }
      {
        ...
        <div className="box mt-4">
          <button className='btn ms-2 px-4 clasifi' style={{backgroundColor:"pink ", color:" orange"}} onClick={setAllProject}>All</button> 
          <button className='btn ms-2 px-4 clasifi' style={{backgroundColor:"pink ", color:" orange"}} onClick={setFrontProject}>Frontend </button> 
          <button className='btn ms-2 px-4 clasifi' style={{backgroundColor:"pink ", color:" orange"}} onClick={setBackndProject}>Backend </button>
        </div>
        <div className='row gx-3 gy-4 mt-2'>
        
          {
            project.slice(0,val).map((pro)=>(
              ...
              <div className='col-xxl-3 col-md-4 col-sm-6 height' key={pro.id}>
              <div className="card " id='card'>
                ...
                <div className="card-body">
                  ...
                  <div className="btns">
                    ...
                    <a className='btn btn2 px-4' href={pro.code} target='_blank'><FontAwesomeIcon icon={ faCodepen}></FontAwesomeIcon>Frontend Code</a>
                    {
                      pro.backcode == "" ? "" : <a className='btn btn3 px-4' href={pro.backcode} target='_blank'><FontAwesomeIcon icon={ faCodepen}></FontAwesomeIcon>Backend Code</a>
                    }
