    ...
    return (
        <div className='col-md-8  ' >
            ...
            <div className='about-box-final pb-1' style={{borderLeft:"5px solid pink"}}>
                ...
                <p>I am actively seeking opportunities as a Junior Frontend Developer / Web Developer, where I can apply my technical skills, learn from experienced professionals, and grow in a collaborative environment. I am particularly interested in roles that involve React, modern JavaScript, responsive design, and UI-focused development. Additionally, I have a strong interest in working in international and multicultural environments, where I can enhance my global exposure, improve my professional skills, and contribute to innovative projects abroad.</p>
            </div>
