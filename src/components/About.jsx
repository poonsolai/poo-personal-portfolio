    ...
    return (
        <div className='col-md-4 ' >
            ...
            <div className='about-box' style={{borderLeft:"5px solid red"}}>
                <FontAwesomeIcon icon={faRProject} style={{width:"30px",height:"30px"}}></FontAwesomeIcon>
                <h1>10+</h1>
                <p>Projects</p>
            </div>
            <div className='about-box' style={{borderLeft:"5px solid pink"}}>
                <FontAwesomeIcon icon={faStackOverflow} style={{width:"30px",height:"30px"}}></FontAwesomeIcon>
                <h1>6</h1>
                <p>Tech Stack</p>
            </div>
            <div className='about-box-final'>
                <h4> <FontAwesomeIcon icon={faEnvira}></FontAwesomeIcon> Interests</h4>
                <ul>
    ...
    return (
        <div className='col-md-8  ' >
            ...
            <div className='about-box-final pb-1'>
                <h4> <FontAwesomeIcon icon={faEnvira}></FontAwesomeIcon> My Approach</h4>
                <ul>
