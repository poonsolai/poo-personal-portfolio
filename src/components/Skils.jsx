  ...
  return (
    <div id='Skils'>
        ...
        <div className="text-center container mt-5" >
            <button className="btn px-3 ms-1 mb-2" onClick={Front} style={{backgroundColor:front?"orange":"",color:front?"white":""}}><FontAwesomeIcon icon={faDartLang} ></FontAwesomeIcon>Frontend</button>
            <button className="btn px-3 ms-1 mb-2" onClick={Back} style={{backgroundColor:back?"orange":"",color:back?"white":""}}><FontAwesomeIcon icon={faDartLang} ></FontAwesomeIcon>Backend</button>
            <button className="btn px-3 ms-1 mb-2" onClick={Design} style={{backgroundColor:design?"orange":"",color:design?"white":""}}><FontAwesomeIcon icon={faDartLang} ></FontAwesomeIcon>Design</button>
            <button className="btn px-3 ms-1 mb-2" onClick={Tools} style={{backgroundColor:tools?"orange":"",color:tools?"white":""}}><FontAwesomeIcon icon={faDartLang}  ></FontAwesomeIcon>Tools</button>
            <button className="btn px-3 ms-1 mb-2" onClick={Other} style={{backgroundColor:others?"orange":"",color:others?"white":""}}><FontAwesomeIcon icon={faDartLang} ></FontAwesomeIcon>Others</button>
        </div>
        {/* Frontend */}

        {
            ...
            <div className="head">
                ...
                <div >
                    <FontAwesomeIcon icon={faNoteSticky} style={{width:"40px",height:"40px"}} className='note'></FontAwesomeIcon>
                </div>
            </div>
            ...
            <div>
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h5 className="Tname">JAVASCRIPT</h5> <h4 className="percentage">80%</h4>
                    </div>
                    <div className="progress">
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h5 className="Tname">BOOTSTRAP</h5> <h4 className="percentage">85%</h4>
                    </div>
                    <div className="progress">
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h4 className="Tname">REACT</h4> <h4 className="percentage">75%</h4>
                    </div>
                    <div className="progress">
        ...
        
        {
            ...
            <div>
                <div className='mt-2'>
                    <div className="box">
                        <h5 className="Tname">NODE + EXPRESS</h5> <h4 className="percentage">70%</h4>
                    </div>
                    <div className="progress">
                        <div className="progress-bar progress-bar-striped progress-bar-animated bg-secondary" style={{width:"70%"}}></div>
                    </div>   
                </div>
                <div className='mt-2'>
                    <div className="box">
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h5 className="Tname">MONGO DB</h5> <h4 className="percentage">70%</h4>
                    </div>
                    <div className="progress">
                        <div className="progress-bar progress-bar-striped progress-bar-animated bg-secondary" style={{width:"70%"}}></div>
                    </div>   
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h4 className="Tname">REST API</h4> <h4 className="percentage">65%</h4>
                    </div>
                    <div className="progress">
                        <div className="progress-bar progress-bar-striped progress-bar-animated bg-secondary" style={{width:"65%"}}></div>
                    </div>   
                </div>
            </div>
            </div>
...

        {
            ...
            <div>
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h5 className="Tname">VSCODE</h5> <h4 className="percentage">90%</h4>
                    </div>
                    <div className="progress">
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h5 className="Tname">NPM</h5> <h4 className="percentage">70%</h4>
                    </div>
                    <div className="progress">
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h5 className="Tname">CHROME DEVTOOLS</h5> <h4 className="percentage">75</h4>
                    </div>
                    <div className="progress">
                ...
                <div className='mt-2'>
                    <div className="box">
                        <h4 className="Tname">POSTMAN</h4> <h4 className="percentage">80%</h4>
                    </div>
                    <div className="progress">
                        <div className="progress-bar progress-bar-striped progress-bar-animated bg-primary" style={{width:"80%"}}></div>
                    </div>   
...

        {
            ...
            <div>
                <div className='mt-2'>
                    <div className="box">
                        <h5 className="Tname">GOOD COMMUNUCATION</h5> <h4 className="percentage">65%</h4>
                    </div>
                    <div className="progress">
                        <div className="progress-bar progress-bar-striped progress-bar-animated " style={{width:"65%",backgroundColor:"tomato"}}></div>
                    </div>   
                </div>
                <div className='mt-2'>
                    <div className="box">
